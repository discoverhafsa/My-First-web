    ...
    return(
        <div>
            <div className="text-center">
                <div className="text-black text-5xl font-bold py-2">Toyota corolla </div>

                <div className="flex justify-center items-center py-10 px-10">
                    <Image src="https://cache1.pakwheels.com/system/car_generation_pictures/5361/medium/Corolla-X-Cars-Cropped-Pictures-for-Website.jpg?1606903674" alt="Toyota corolla" width={420} className="border-black" />
                </div>
