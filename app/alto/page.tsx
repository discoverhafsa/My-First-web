    ...
    return(
        <div>
            <div className="text-center">
                <div className="text-black text-5xl font-bold py-2">Suzuki Alto </div>

                <div className="flex justify-center items-center  py-10 px-10">
                    <Image src="https://cache4.pakwheels.com/system/car_generation_pictures/6013/medium/Suzuki_Alto_-_PNG.png?1635945100"
                     alt="Suzuki Alto" width={420} className="border-black"/>
                </div>
